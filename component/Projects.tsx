...
const projects = [
  // ── Full Stack ──
  {
    ...
    description:
      'A modern electronics e-commerce platform with category-wise browsing, secure Firebase & JWT auth, cart/buy-now flow, and role-based admin dashboard for managing products, users & orders.',
    category: 'Full Stack',
    tags: ['React', 'Node.js', 'MongoDB', 'Firebase', 'JWT', 'TanStack Query'],
    live: 'https://client-electropoint.web.app/',
    github: '#',
    featured: true,
    gradient: 'from-[#c8f135]/20 to-[#7c3aed]/10',
    dotColor: '#c8f135',
  },
  {
    id: 2,
    ...
    description:
      'A comprehensive e-learning platform with live sessions, downloadable resources, quizzes, personalized course recommendations, and real-time progress tracking for students.',
    category: 'Full Stack',
    tags: ['React', 'Node.js', 'MongoDB', 'Express', 'Firebase'],
    live: 'https://online-class-5f780.web.app/',
    github: '#',
    featured: false,
    gradient: 'from-[#7c3aed]/20 to-[#c8f135]/10',
    dotColor: '#7c3aed',
  },
  {
    id: 3,
    ...
    description:
      'A full-stack MERN app for managing books with pagination, sorting, and category filtering. Demonstrates clean CRUD operations and responsive UI without auth complexity.',
    category: 'Full Stack',
    tags: ['MongoDB', 'Express', 'React', 'Node.js', 'Tailwind CSS'],
    live: 'https://book-managment-system-mern.vercel.app/',
    github: '#',
    featured: false,
    gradient: 'from-[#c8f135]/15 to-[#7c3aed]/15',
    dotColor: '#c8f135',
  },
  ...
  // ── Frontend ──
  {
    ...
    description:
      'A fully-featured Beauty and Jewelry e-commerce site built with Next.js & TypeScript. Includes admin panel, real-time order tracking, inventory management, and detailed analytics.',
    category: 'Frontend',
  ...
  },
  {
    ...
    description:
      'A curated info platform about Japan with blogs, top categories, today\'s deals, and best-selling products. Features Firebase auth, dynamic routing, and seamless responsive design.',
    category: 'Frontend',
  ...
  },
  {
    ...
    description:
      'A travel management platform with diverse packages, detailed itineraries, secure bookings, real-time availability, user reviews, and destination guides for a seamless travel experience.',
    category: 'Frontend',
    tags: ['React', 'Firebase', 'Tailwind CSS'],
    live: 'https://traval-tour-62d62.web.app/',
    github: '#',
    featured: false,
    gradient: 'from-[#7c3aed]/15 to-[#c8f135]/15',
    dotColor: '#7c3aed',
  },
]
      ...
      <div className="relative z-10  px-8 md:px-16">
        ...
        <div className="flex flex-col items-center mb-14">
          ...
          <h2 className="font-syne text-4xl md:text-5xl font-extrabold text-white mb-4">
            My <span className="text-[#c8f135]">Projects</span>
          </h2>
        ...
        <div className="flex justify-center gap-3 mb-12 flex-wrap">
          {filters.map((f) => (
            ...
            >
              {f}
              {f !== 'All' && (
                <span className={`ml-2 text-[10px] px-1.5 py-0.5 rounded-full ${active === f ? 'bg-black/20' : 'bg-white/10'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((project) => (
            <div
              key={project.id}
              className="group relative flex flex-col rounded-2xl border border-white/6 bg-white/[0.02] hover:border-white/12 transition-all duration-300 overflow-hidden"
            >
              {/* Top gradient banner */}
              <div className={`relative h-[140px] bg-gradient-to-br ${project.gradient} flex items-center justify-center overflow-hidden`}>
                {/* Grid pattern inside banner */}
                <div
              ...
              <div className="flex flex-col flex-1 p-5">
                ...
                <p className="text-[#c8f135]/60 font-mono text-xs mb-3">{project.subtitle}</p>
                ...
                <div className="flex gap-3 mt-auto">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-gradient-to-r from-[#c8f135] to-[#a3e635] text-black font-syne font-bold text-xs tracking-wide hover:scale-105 transition-transform"
                  >
              ...
              <div
                ...
                style={{ background: `linear-gradient(to right, ${project.dotColor}, #7c3aed)` }}
              />
            </div>
          ))}
        </div>
        ...
        <p className="text-center text-white/20 text-xs font-mono tracking-widest mt-14 uppercase">
          More projects on{' '}
          <a href="#" className="text-[#c8f135]/50 hover:text-[#c8f135] transition-colors duration-300">
            GitHub →
          </a>
        </p>
